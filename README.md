...
In this repo I train an agent to navigate (and collect bananas!) in a large, square world.  

![Trained Agent][image1]

In this enviornment, a reward of +1 is provided for collecting a yellow banana, and a reward of -1 is provided for collecting a blue banana.  Thus, the goal of your agent is to collect as many yellow bananas as possible while avoiding blue bananas.  
...
Then, place the file in the folder for DeepQNetwork GitHub repository, and unzip (or decompress) the file.  Next, to train the agent ...
